...
class TextGroup(object):
    ...
    def setupText(self):
        ...
        self.alltext[AMMOTXT] = Text(str(10).zfill(2), WHITE, 10*TILEWIDTH, TILEHEIGHT, size)
        ...
        self.addText("AMMO", WHITE, 10*TILEWIDTH, 0, size)
    ...
    def updateAmmo(self, ammo):
        self.updateText(AMMOTXT, str(ammo).zfill(2))
